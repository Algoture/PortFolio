...
const SkillChip = ({ skill, index }) => {
  return (
    <motion.div
      ...
      <div className="relative px-4 py-2 bg-neutral-900/60 border border-neutral-800 hover:border-[#01ff00]/50 transition-colors duration-300 overflow-hidden cursor-default">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#01ff00]/10 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out" />

        <div className="absolute top-0 left-0 w-[2px] h-[2px] bg-neutral-600 group-hover:bg-[#01ff00]" />
        <div className="absolute bottom-0 right-0 w-[2px] h-[2px] bg-neutral-600 group-hover:bg-[#01ff00]" />

        <div className="absolute top-1/2 -left-[1px] w-[2px] h-2 bg-neutral-800 group-hover:bg-[#01ff00] transition-colors transform -translate-y-1/2" />

        <div className="flex items-center gap-2">
          <span className="text-[9px] text-neutral-600 font-mono group-hover:text-[#01ff00] transition-colors">
            0{(index % 9) + 1}
          </span>
      ...
      {[...Array(12)].map((_, i) => (
        <motion.div
          ...
          className={`h-full flex-1 ${
            i < 9 ? "bg-[#01ff00]/40" : "bg-neutral-800"
          }`}
        />
      ))}
    </div>
    <span className="text-[9px] text-[#01ff00] font-mono">78%</span>
  </div>
);
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 border-b border-neutral-800 pb-4">
          <div>
            <motion.div
              ...
              className="h-[2px] bg-[#01ff00] mb-2"
            />
          ...
          <div className="text-right hidden md:block">
            ...
            <div className="text-xl font-mono text-[#01ff00] leading-none">
